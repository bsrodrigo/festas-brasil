...
import { IThemeOptions } from '@/modules/core/presenters/components/bosons/theme'
...
export const Theme = createTheme({
  ...
  typography: {
    ...
    subtitle1: { fontSize: '1rem', fontWeight: 400, lineHeight: '1.375rem', letterSpacing: '0.065rem' },
    subtitle2: { fontSize: '0.875rem', fontWeight: 700, lineHeight: '1.188rem', letterSpacing: '0.065rem' },
    body1: { fontSize: '1rem', fontWeight: 400, lineHeight: '1.500rem', textTransform: 'inherit' },
    body2: { fontSize: '0.875rem', fontWeight: 400, lineHeight: '1.313rem', textTransform: 'inherit' },
    button: {
      fontSize: 16,
      fontWeight: 600,
      lineHeight: '150.69%',
