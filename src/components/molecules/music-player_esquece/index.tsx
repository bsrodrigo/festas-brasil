    ...
    <div className={classes.player}>
      ...
      <div className={classes.songPanel}>
        <div className={classes.songInfo}>
          <p className={classes.songInfoMusic}>Ukulele</p>
          <div className={classes.songInfoArtist}>Bensound</div>
      ...
      <div className={classes.controls}>
        <div className={classes.spinner}>
          <div
            className={classes.spinnerDisc}
            style={{
              backgroundImage:
                "url(https://www.bensound.com/bensound-img/ukulele.jpg)",
            }}
          >
            <div className={classes.centerDisc}></div>
          </div>
        </div>
        ...
        <button className={classes.play}>
          <i>icon</i>
          <span className={(classes.pause, classes.left)}>pause left</span>
          <span className={(classes.pause, classes.right)}>pause right</span>
        </button>
